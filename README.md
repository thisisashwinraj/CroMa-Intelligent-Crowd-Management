...
Safegaurding your data starts with understanding how CroMa collects and processes your information. The in-hand ticketing machine only collects data pertaining to the starting location, destination and number of co-passengers. When this data is shared, all that CroMa records is that few passengers bought ticket(s) and onboarded the bus, but it doesn't know who they exactly are. CroMa does not collect your personal data in any form. Analogously on the application side, CroMa does'nt require users to logIn to the application. Users can simply startoff without explicitly signing up for the app. 
