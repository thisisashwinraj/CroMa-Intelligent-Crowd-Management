...
<br>
• **Ticket Machine:** [Python 3.7](https://www.python.org/downloads/release/python-370/), Firebase (Real-Time Database), RaspberryPi and ArduinoUNO | Dependencies: [Pyrebase](https://pypi.org/project/Pyrebase/)
...
The firebase database is secured by means of firebase rules, that ensures only authenticated users are allowed to manipulate the data. 
